      ...
      <div class="card-content">
        ...
        <div class="table-responsive">
          <table class="table table-hover mb-0">
            ...
            <tbody>
              @if(count($modelzadashar) > 0)
                @foreach($modelzadashar as $key=>$modelzadasha)
                    <tr>
                        <td>{{$key + 1}}</td>
                        <td>{{@$modelzadasha->КодПрЗ}}</td>
                        <td>{{@$modelzadasha->НаименованиеПрЗ}}</td>
                        <td>{{@$modelzadasha->КоличествостатКМвПрЗ}}</td>
                        <td>
