        ...
        <div class="card offset-lg-2 col-md-12 col-sm-12 col-lg-8 p-0">
            ...
            <div class="card-body row p-3">
                ...
                <div class="form-group col-sm-6 col-md-6 col-lg-4  mt-0 mb-1 pb-0">
                    ...
                    <input type="password" name="password" value="" id="password" autocomplete="off" class="mt-0 form-control">
                </div>
                <div class="form-group col-sm-6 col-md-6 col-lg-4  mt-0 mb-1 pb-0">
                ...
                <div class="form-group col-12 pb-0">
                    <label for="edit_deliveryman" class="control-label" style="margin:0px;padding:0;">&nbsp;</label>
                    <button type="submit" name="edit_deliveryman" id="edit_deliveryman"   class="btn btn-primary  waves-effect waves-primary mt-4 pt-1 pb-1 pl-3 pr-3"><i data-feather="send"></i> Update</button>
                </div>
