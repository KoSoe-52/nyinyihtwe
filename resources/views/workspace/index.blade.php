...
<!--select  t5.* from предметзадача t1 left join  моделизадачи t2
on t1.КодПрЗ=t2.КодПрЗ
LEFT JOIN км t3 ON t2.КодКМ=t3.КодКМ
LEFT JOIN составк_моделиизструктур  t4 ON t4.КодКМ=t3.КодКМ
LEFT JOIN структуры t5 ON t4.Кодстатструктуры = t5.Кодструктуры OR
t4.Коддинструктуры=t5.Кодструктуры OR t4.Кодструктурыувязки=t5.Кодструктуры-->
@endsection
@section("script")
